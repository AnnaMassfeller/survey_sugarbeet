        ...
        <div style="padding: 5px; margin: 5px; border: 1px; border-style: ridge; border-color: white; border-radius: 11px 11px 11px 11px;"> 
          ...
          <legend style="font-size: 100%;">
            <ul style="margin: 2px; padding: 10px">
              ...
              <br>
              <li><mark style="color: #1adee8; font-weight: normal; background: none; font-size: 120%"><i>Unter je 100 Teilnehmenden haben wir wir drei Gutscheine im Wert von 50 € für Engelbert Strauss verlost.</i></mark></li>
            </ul>  
          </legend>
        </div>
